...
namespace Cinecon
{
    public class Program
    {
        static void Main()
        {
            ...
            {
                { "Bezoeker", Example },
                { "Medewerker", () => ConsoleHelper.ColorWriteLine("Yo ik ben een medewerker", ConsoleColor.Green) },
            });
            ...
            // Voorbeeld: Als de gebruiker kiest voor "bezoeker", dan wordt de functie "Example" gecalled.
            choice.Value();
        }

        public static void Example()
        {
            ConsoleHelper.ColorWriteLine("Yo ik ben een bezoeker", ConsoleColor.Cyan);
        }
    }    
}